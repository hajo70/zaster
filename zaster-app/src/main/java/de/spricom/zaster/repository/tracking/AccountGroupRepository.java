...
public interface AccountGroupRepository
        extends JpaRepository<AccountGroupEntity, String>, JpaSpecificationExecutor<AccountGroupEntity> {
    ...
    AccountGroupEntity findByTenantIdAndAccountCode(String tenantId, String accountCode);
}
